...
We have modified our `prisma.schema` as described [here](https://notiz.dev/blog/prisma-dbml-generator) to export into a `schema.dbml` file to be used in [dbdiagram.io](https://dbdiagram.io/home) for visualization and the to be [embedded](https://dbdiagram.io/docs/embedding) in this wiki as shown below:
